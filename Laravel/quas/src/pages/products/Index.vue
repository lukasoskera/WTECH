      ...
      <q-tr slot="body" slot-scope="props" :props="props">
        ...
        <q-td class="text-right">
          ...
          <div v-else>
            ...
            <q-btn round icon="delete" @click="destroy(props.row.id, props.row.name, props.row.slug, props.row.__index)"/>
          </div>
        </q-td>
      </q-tr>
    </q-table>
        ...
        data () {
            return {
                columns: [
                    ...
                    { slug: 'slug', label: 'Slug', field: 'slug', sortable: true, align: 'left' },
        ...
        methods: {
            ...
            destroy (id, name, slug, rowIndex) {
                this.$q.dialog({
                    ...
                    //console.log(`http://127.0.0.1:8000/home/${slug}`)
                    axios
